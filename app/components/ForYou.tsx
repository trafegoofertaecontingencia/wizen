        ...
        <div className="mt-15 flex flex-col items-center">
            ...
            <ul className="m-6 mt-0 flex flex-col gap-1 mb-4">
                <li className="flex gap-3 items-center">
                    ...
                    <p>Você recebe e o dinheiro some</p>
                </li>
                <li className="flex gap-3 items-center">
                    <IoIosCheckmarkCircle className="text-blue-500 text-2xl" />
                    <p>Já tentou planilhas mas não funcionou</p>
                </li>
                <li className="flex gap-3 items-center">
                    <IoIosCheckmarkCircle className="text-blue-500 text-2xl" />
                    <p>Quer guardar dinheiro mas não sabe como</p>
                </li>
                <li className="flex gap-3 items-center">
                    <IoIosCheckmarkCircle className="text-blue-500 text-2xl" />
                    <p>É CLT ou MEI e quer controle real</p>
                </li>
            </ul>
        </div>
    )
