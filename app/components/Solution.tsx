...
export default function Solution() {
    return (
        <div className="flex flex-col items-center mt-15">
            ...
            <p className="md:text-lg">Mas a solução pode estar no seu bolso, literalmente!</p>
            <Image
            ...
            <p className="max-w-[600px] text-center md:text-lg">Um app com inteligência artificial que entende sua realidade, te
